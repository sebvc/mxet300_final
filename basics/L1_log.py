...
def writeFiles(current_phis):
    txt = open("/home/pi/basics/PDL.txt", 'w+')         # file for phi dot left
    txt2 = open("/home/pi/basics/PDR.txt", 'w+')        # file for phi dot right
...
def NodeRed2(values):                                       # this function takes a 2-element array called val
    txt = open("/home/pi/mxet300_lab21/basics/a.txt", 'w+')           # file for generic variable a
    txt2 = open("/home/pi/mxet300_lab21/basics/b.txt", 'w+')          # file for generic variable b
    a = round(values[0], 2)
    b = round(values[1], 2)
    txt.write(str(a))
    txt2.write(str(b))
...
def uniqueFile(value, fileName):                            # this function takes a 2-element array called val
    txt = open("/home/pi/mxet300_lab21/rw_files/" + fileName, 'w+')     # file with specified name
    myValue = round(value, 3)

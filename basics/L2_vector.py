...
def getNearest(lidar_points=54):                                   # combine multiple functions into one.  Call to get nearest obstacle.
    scan = lidar.polarScan(lidar_points)                        # get a reading in meters and degrees
